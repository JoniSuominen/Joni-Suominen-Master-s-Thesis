...
\def\myfititle{Värinkorjaus Spliiineillä}
\def\myentitle{Värinkorjaus Spline-käyrillä}
...
\def\myexaminers{Professor Karen Equiazarian \\ Researcher Vladimir Katkovnik \\ ...}
...
\input{tex/hvs}
\input{tex/colorimaging}
\input{tex/colourspaces}
\input{tex/colourcorrection}
\input{tex/algorithm}
\input{tex/results}
